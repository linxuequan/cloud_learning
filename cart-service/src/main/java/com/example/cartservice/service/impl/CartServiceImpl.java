...
import com.example.cartservice.config.Properties;
...
//                instance.getUri()+"/items?ids={ids}",  //路径
//                HttpMethod.GET,   //方式
//                null, //请求实体
//                new ParameterizedTypeReference<List<ItemDTO>>() {}, // 返回值类型
//                CollUtil.join(itemIds,",") //请求参数， id1，id2，id3..
//        );
...
//            throw new BadRequestException("购物车商品不存在");
    ...
    private void checkCartsFull(Long userId) {
        ...
        if (count >= properties.getMaxAmount()) {
            throw new BizIllegalException(StrUtil.format("用户购物车课程不能超过{}", properties.getMaxAmount()));
        }
    }
